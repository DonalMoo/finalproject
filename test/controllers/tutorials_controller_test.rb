...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { description: @tutorial.description, image_url: @tutorial.image_url, price: @tutorial.price }
    end
  ...
  test "should update tutorial" do
    patch :update, id: @tutorial, tutorial: { description: @tutorial.description, image_url: @tutorial.image_url, price: @tutorial.price }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
