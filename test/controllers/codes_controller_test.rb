...
class CodesControllerTest < ActionController::TestCase
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post :create, code: { campaign_id: @code.campaign_id, code: @code.code, redeemed_at: @code.redeemed_at }
    end
  ...
  test "should update code" do
    patch :update, id: @code, code: { campaign_id: @code.campaign_id, code: @code.code, redeemed_at: @code.redeemed_at }
    assert_redirected_to code_path(assigns(:code))
  end
